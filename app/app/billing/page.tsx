...
export default async function BillingPage({
  ...
  // Live subscription + invoices from Stripe (paid plans); trial usage for trial plans.
  const overview = company.stripeSubId
    ? await getBillingOverview(company.stripeSubId, company.stripeCustomerId)
    : null;
  const trial = currentPlan === 'trial' ? await getTrialUsage(daraUser.companyId) : null;
