...
- ⏳ **M6–M7** — pending: wiring polish + mode immutability guard + color‑team regression QA; security review + docs. *(Runtime verification of an actual review run still needs a live DB + API key + applied migration.)*
