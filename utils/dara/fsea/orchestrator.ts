...
export async function runFSEA(
  ...
  try {
    ...
    // Bare catch: strict useUnknownInCatchVariables rejects instanceof narrowing on the
    // catch binding under the Vercel build (see commit b4844e6). Keep it parameterless.
