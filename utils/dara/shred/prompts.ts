...
3. disposition — scored, compliance, or administrative:
   - scored — affects the evaluation rating (tied to a Section M factor / evaluated work).
   - compliance — a SUBSTANTIVE, solicitation-specific pass/fail obligation the offeror must meet or address that is particular to THIS effort's scope of work (a specific performance task, deliverable/CDRL, or technical requirement).
   - administrative — anything non-scored and non-differentiating that recurs across essentially every federal contract. This covers BOTH (a) proposal submission mechanics (forms, formatting, page limits, volume/submission logistics) AND (b) standard flow-down compliance mandates: security clearances and facility/installation access (SECRET, DD Form 254), mandatory training (OPSEC / Antiterrorism / AT Level I / iWATCH / TARP / cyber- or IA-awareness / DoD 8570 / ATCTS), background checks and identity verification (PIV, HSPD-12, FAR 52.204-9), IT/cybersecurity compliance (NIST 800-171, DFARS 252.204-7012, safeguarding CUI), and registrations (SAM.gov). When a boilerplate obligation that every contractor must meet could be either compliance or administrative, choose administrative.
